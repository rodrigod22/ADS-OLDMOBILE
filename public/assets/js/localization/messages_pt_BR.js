...
$.extend( $.validator.messages, {
	...
	// Core
	required: "<span class=' alert alert-danger p-1 m-0'>Campo Obrigatório </span>",
	...
	minlength: $.validator.format( "<span class=' alert alert-danger p-1 m-0'>Esta faltando numeros, favor completar</span>" ),
	...
	cpfBR: "<span class='alert alert-danger p-1 m-0'> Por favor, forne&ccedil;a um CPF v&aacute;lido. </span>"
} );
return $;
}));
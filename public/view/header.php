...
<html>
    <head>
        <title>Old-Mobile Plataforma Elétrica</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="container">
     <div class="jumbotron bg-light">OLD-MOBILE PLATAFORMA ELÉTRICA</div>
     
<nav class="navbar navbar-expand-md mr-0" id="menu_princ">

                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon">&#9776</span>
                </button>
                <div class="collapse navbar-collapse justify-content-between" id="navbarNavDropdown">
                    <ul class="navbar-nav ml-md-5 ml-0">
                       
                        <li class="nav-item active ">
                            <a  href="index"> <i class="fa fa-home pr-1"></i> Home </a>
                        </li>  
                        ...
                        <li class="nav-item ml-2">
                            <a href="lista-cliente"><i class="fa fa-file-text pr-1"></i> Lista Cliente</a>
                        </li>
                        
                        <li class="nav-item ml-2">
                            <a href="contato.php"><i class="fa fa-envelope pr-1"></i> Contato</a>
                        </li>                       
                    </ul>
                </div>
</nav>
